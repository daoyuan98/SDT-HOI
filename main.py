...
from utils_upt import custom_collate, CustomisedDLE, DataFactory
...
def main(rank, args):
    ...
    param_dicts = [
        ...
        if "interaction_head" in n and p.requires_grad]}, # only train the interaction head
    ]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_scaler', default=3.0, type=float)
    parser.add_argument('--encoder_layer', default=4, type=int)
    parser.add_argument('--comp_layer', default=3, type=int)
    parser.add_argument('--aug_var', default=0.1, type=float)
    parser.add_argument('--lr-decay', default=0.1, type=float)
    parser.add_argument('--cls', default='linear', type=str)
    parser.add_argument('--num_heads', default=8, type=int)
    parser.add_argument('--mix_ratio', default=0.1, type=float)
